        ...
        <div id="content">
            ...
            <div class="fixed-filters bg-light">
                <ul class="nav nav-tabs nav-justified">
                    <li class="nav-item">
                        <button type="button" class="nav-link {{ $active_tab_class }}">Applicants/Attachees</button>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('central_services.departments_users') }}"
                            class="nav-link {{ $department_tab_class }}">Departments</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('central_services.dipca_users') }}"
                            class="nav-link {{ $dipca_tab_class }}">Dipca</a>
                    </li>
                </ul>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td class="align-middle">{{ $user->national_id }}</td>
                                            ...
                                            <td class="align-middle">
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a href="{{ route('central_services.reset_user_password', $user->user->id) }}"
                                                                class="dropdown-item" wire:click="">Reset
                                                                Password</a>
                                                        </li>
                                                        <li><button class="dropdown-item"
                                                                wire:click="toggleAccountActivation('{{ $user->user->id }}')">Activate/Deactivate</button>
                                                        </li>
                                                        <li><button class="dropdown-item"
                                                                wire:click="warn('delete', '{{ $user->user->id }}')">Delete</button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
