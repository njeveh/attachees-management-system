                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{ Storage::url($attachee->recommendationLetter->path) }}" class="btn btn-success">view</a>
                                                    <button class="btn btn-primary" data-bs-toggle="collapse"
                                                    data-bs-target="#update-letter-{{ $attachee->id }}">
                                                    Update
                                                    </button>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="m-0 p-0">
                                            <td colspan='7' class="m-0 p-0">
                                                <div wire:ignore.self
                                                    ...
                                                    id="update-letter-{{ $attachee->id }}">
                                                    <form id="reason-input-form-{{ $attachee->id }}"
                                                        wire:submit.prevent="update('{{ $attachee->id }}')">
