<div>
    ...
    <div x-data='actionScripts' x-data="{side_nav_open: false}" id="home-page-wrapper">
                        ...
                        <div class="logo-brand">
                            ...
                            <span>
                                <!-- JOMO KENYATTA UNIVERSITY OF AGRICULTURE AND TECHNOLOGY
                                                                                                                                                                    <br /> -->
                                <h5 class='logo-text' style="color: white; text-decoration:none;">JKUAT INDUSTRIAL ATTACHMENT PORTAL</h5>
                            </span>
                        </div>
                    </a>
                    ...
                    <div id="home-page-carousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="/assets/static/istockphoto-1204089458-170667a.jpg" alt="JKUAT INDUSTRIAL ATTACHMENT PORTAL"
                                    class="d-block w-100">
                                ...
                                <div class="job-posts px-2">
                                    @if ($adverts->count() > 0)
                                        ...
                                        <div class="items-list">
                                            <div class="my-4 mx-2 py-3 px-2 text-light rounded bg-info" style="font-size: 15px;">
                                                All featured Opportunities are open for applications. However, please view adverts to see whether the period within which you intend to be attached
                                                has declared vacancies for a particular advert.
                                            </div>
