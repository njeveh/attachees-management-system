                        ...
                        <div class="items-list">
                                ...
                                @foreach ($applications as $application)
                                    <div class="list-item row shadow p-3 mb-5 bg-body rounded">
                                        ...
                                        <div
                                            ...
                                            <a href="{{ '/attachee/my-reviewed-applications/' . $application->id . '/links' }}"
                                                class="btn btn-primary">Downloads</a>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            @else
                                <div
                                    ...
                                    <div class="m-2">
                                        You do not have any reveiwed applications yet.
                                    </div>
                                    <div class="mb-4">
                                        <a class="btn btn-success" href='/attachee/my-applications/'>View your applications.</a>
                                    </div>
                                </div>
                            @endif
                        </div>
