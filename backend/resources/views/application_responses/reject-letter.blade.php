            ...
            <section id="letter-body">
                <div>
                    ...
                    <div id="main-body">
                        ...
                        invested in
                        applying for our post opening.<br><br>

                        We received a large number of applications, and after carefully reviewing all of them,
                        unfortunately, we have to inform
                        you that this time we won’t be able to invite you to work with us.
                        Though your qualifications are impressive, we have decided to move forward with candidates whose
                        qualifications better
                        meet our needs for this particular role. However, we really do appreciate your interest.<br><br>

                        If you have any questions or need additional information, please don’t hesitate to contact us
                        via email [insert your
                        email address].<br><br>
