...
class EditAdvert extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->study_areas = $this->advert->department->studyAreas;
        $this->fill([
    ...
    {
        return view('livewire.central-services.edit-advert');
    }
    ...
    public function updateAdvert()
    {
        ...
        return redirect('/central-services/view-advert/' . $this->advert->id);
    }
}